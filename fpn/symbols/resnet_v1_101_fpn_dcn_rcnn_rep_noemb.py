...
class resnet_v1_101_fpn_dcn_rcnn_rep_noemb(Symbol):
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        #batch_embed = mx.sym.L2Normalization(name='batch_embed', data=x)
        batch_embed = mx.sym.identity(name='batch_embed',data=fc_new_2_relu)  #TODO: the diffrerence
        ...
        bg_scores = mx.sym.broadcast_sub(
            ...
            mx.sym.max_axis(comb_cls_scores, axis=1, keepdims=True)
        )
