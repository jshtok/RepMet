...
class PascalVOC(IMDB):
    def __init__(self, image_set, root_path, devkit_path, result_path=None, mask_size=-1, binary_thresh=None, categ_index_offs=0, per_category_epoch_max=0,classes_list_fname='',num_ex_per_class=''):
        """
